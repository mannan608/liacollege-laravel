...
@section('title', 'CHC52025 - Diploma of Community Services')
@section('content')
            ...
            <div class="container">
                <div class="row g-5">
                    ...
                    <div class="col-lg-8">
                        <!-- ABOUT -->
                        <section id="about">
                            <div class="dlm-section-label">CHC52025</div>
                            <h2 class="dlm-section-title">Diploma of Community Services</h2>
                            <img src="{{ asset('frontend/images/banner/community_services.png') }}" alt="Community Services" />
                ...
                <div class="dlm-jobs-strip">
                    ...
                    <div class="dlm-job-tag"><span class="tag-dot"></span>Work collaboratively with community organisations and support networks</div>
                    <div class="dlm-job-tag"><span class="tag-dot"></span>Facilitate community participation and empowerment</div>
                    <div class="dlm-job-tag"><span class="tag-dot"></span>Promote culturally responsive and inclusive practices</div>
                    <div class="dlm-job-tag"><span class="tag-dot"></span>Apply legal and ethical frameworks within community services</div>
                ...
                <section id="outcomes">
                    ...
                    <p class="dlm-section-desc">On successful completion, you will receive a nationally recognised <strong>CHC52025 Diploma of Community Services</strong> — demonstrating your ability to design, coordinate and deliver community support programs while assisting individuals and families to improve their wellbeing and access appropriate services.</p>
                    ...
                    <div class="dlm-industries">
                        ...
                        <span class="dlm-industry-tag">🏠 Housing and Homelessness Services</span>
                        <span class="dlm-industry-tag">🧠 Mental Health Support Organisations</span>
                        <span class="dlm-industry-tag">🤝 Non-Profit and Community Organisations</span>
                        <span class="dlm-industry-tag">♿ Disability and Social Inclusion Programs</span>
                    </div>
                </section>
                ...
                <section id="units">
                    ...
                    <div id="panel-core" class="dlm-unit-panel active">
                        ...
                        <div class="dlm-unit-row dlm-core-badge">
                            ...
                            <span class="unit-title">Analyse impacts of sociological factors on people in community work and services</span>
                        </div>
                        <div class="dlm-unit-row dlm-core-badge">
                            <span class="unit-badge">CHCDFV001</span>
                            <span class="unit-title">Recognise and respond appropriately to domestic and family violence</span>
                        </div>
                        <div class="dlm-unit-row dlm-core-badge">
                    ...
                    <div id="panel-elective" class="dlm-unit-panel">
                        <div class="dlm-unit-row">
                            ...
                            <span class="unit-title">Provide services for the needs and circumstances of young people</span>
                        </div>
                        <div class="dlm-unit-row">
                        ...
                        <div class="dlm-unit-row">
                            ...
                            <span class="unit-title">Identify and respond to children and young people at risk</span>
                        </div>
                        <div class="dlm-unit-row">
                        ...
                        <p style="font-size:13px;color:rgba(10,10,18,0.45);margin-top:12px;">Alternate elective combinations may be available for corporate programs or customised workplace delivery (additional fees may apply).</p>
                    </div>
                </section>
                ...
                <section id="delivery">
                    ...
                    <div class="dlm-delivery-cards">
                        ...
                        <!--        <li>Career changers entering the social services sector</li>-->
                        <!--        <li>Support workers seeking leadership roles</li>-->
                        <!--        <li>Individuals balancing work and study commitments</li>-->
                        <!--    </ul>-->
                        <!--</div>-->
                        <!--<div class="dlm-delivery-card">-->
                        <!--    <div class="dc-icon-wrap">🏢</div>-->
                        ...
                        <!--        <li>Aligned to organisational programs</li>-->
                ...
                <section id="pathways">
                    ...
                    <div class="dlm-pathway-flow" style="margin-top:28px;">
                        ...
                        <div class="dlm-pathway-card current">
                            <div class="pf-icon">⭐</div>
                            <div class="pf-code">CHC52025</div>
                    ...
                    <p style="margin-top:24px; color:rgba(10,10,18,0.7);">Further study can support progression into program management, policy development and leadership roles within the community services sector.</p>
                    ...
                    <div class="dlm-accordion">
                        ...
                        <div class="dlm-accordion-item open">
                            ...
                            <div class="dlm-accordion-body">
                                <p>The CHC52025 is part of the Community Services Training Package, regulated by the Australian Skills Quality Authority (ASQA). It is recognised by employers across every state and territory and all community service sectors in Australia as the standard for community services practice.</p>
                            </div>
                        </div>
