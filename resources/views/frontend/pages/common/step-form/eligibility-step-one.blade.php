    ...
    <form x-show="step === 1" x-transition @submit.prevent="submitStep1" class="space-y-6">
        <div class="space-y-5">
            <div>
        ...
        <div class="pt-4 flex justify-between items-center">
            <button  type="button" disabled class="text-on-surface-variant hover:text-on-surface font-body-md text-sm transition-colors disabled:opacity-50 cursor-not-allowed"
            >
                Back
            </button>
    ...
    <form
        x-show="step === 2 && !success" x-transition @submit.prevent="submitStep2" class="space-y-6" id="eligibilityForm">
        <div class="space-y-5">
            <div>
