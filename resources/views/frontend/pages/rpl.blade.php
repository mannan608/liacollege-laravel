        ...
        <section class="relative w-full min-h-[80vh] flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div class="grid grid-cols-1 md:grid-cols-[65%_35%] gap-8">
                    <div class="max-w-3xl">
                        <div
                            class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-brand-200 text-sm font-medium mb-6">
                            <span class="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
                            Nationally Recognised Qualifications
                        </div>
                        <h1
                            class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6 tracking-tight">
                            Convert Your On-the-Job Experience into <span class="text-secondary-500">Formal
                                Credentials</span>
                        </h1>
                    ...
                    <div class="p-8 rounded-[20px] relative overflow-hidden bg-white">
                      ...
                      <h2 class=" md:text-3xl sm:text-2xl text-xl font-bold text-on-surface mb-8">Check Your Eligibility</h2>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    <div class="w-full lg:w-1/2">
                        <div
                            class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-50 text-brand-700 text-sm font-semibold mb-4">
                            What is RPL?
                        </div>
                        ...
                        <div class="space-y-4 text-slate-600 leading-relaxed">
                            <p class="text-lg">
                                You've spent years accumulating valuable skills on the job. You know your industry inside
                                and out, but sometimes, experience alone isn't enough to open certain doors without formal
                                recognition.
                            </p>
                            <p>
                                Recognition of Prior Learning (RPL) is a formal assessment method within the Vocational
                                Education and Training (VET) system. It evaluates your existing competencies against the
                                requirements of a formal qualification.
                            </p>
                            <p>
                                Instead of starting from scratch, RPL allows you to gain course credits or a full
                                qualification based on what you already know, saving you significant time and money without
                    ...
                    <div class="w-full lg:w-1/2">
                        <div class="relative">
                            <div
                                class="absolute -inset-4 bg-gradient-to-r from-brand-600 to-indigo-600 rounded-3xl opacity-10 blur-2xl">
                            </div>
                            <img class="relative rounded-2xl shadow-2xl object-cover w-full h-auto aspect-video border border-slate-100"
        ...
        <section class="py-20 lg:py-28 bg-slate-50 w-full">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-lg text-slate-600 max-w-2xl mx-auto">Key eligibility factors to ensure your experience
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    <!-- Card 1 -->
                    <div
                        class="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                        <div
                            class="w-14 h-14 rounded-xl bg-gradient-to-br from-brand-500 to-brand-600 text-white flex items-center justify-center mb-6 shadow-lg shadow-brand-500/25 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <p class="text-slate-600 leading-relaxed">Significant and relevant on-the-job experience in your
                            industry.</p>
                    </div>
                    ...
                    <div
                        class="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                        <div
                            class="w-14 h-14 rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-600 text-white flex items-center justify-center mb-6 shadow-lg shadow-indigo-500/25 group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p class="text-slate-600 leading-relaxed">Ability to prove your skills match the qualification
                            requirements.</p>
                    </div>
                    ...
                    <div
                        class="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                        <div
                            class="w-14 h-14 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 text-white flex items-center justify-center mb-6 shadow-lg shadow-emerald-500/25 group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <section class="py-20 lg:py-28 bg-white w-full">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-lg text-slate-600 max-w-2xl mx-auto">A streamlined pathway to turning your experience
                        into qualifications.</p>
                </div>

                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 relative">
                    <!-- Connecting Line (Desktop) -->
                    <div
                        class="hidden lg:block absolute top-8 left-[10%] right-[10%] h-0.5 bg-gradient-to-r from-brand-200 via-indigo-200 to-brand-200">
                    </div>

                    <!-- Step 1 -->
                    <div class="relative text-center group">
                        <div
                            class="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-brand-500 to-brand-600 text-white flex items-center justify-center text-xl font-bold mb-5 shadow-lg shadow-brand-500/30 relative z-10 group-hover:scale-110 transition-transform duration-300">
                            1
                        </div>
                        <h3 class="font-bold text-lg text-slate-900 mb-2">Select Accredited Provider</h3>
                        <p class="text-sm text-slate-600 leading-relaxed">Find an RTO offering your desired qualification.
                        </p>
                    </div>
                    ...
                    <div class="relative text-center group">
                        ...
                        <p class="text-sm text-slate-600 leading-relaxed">Discuss your background to determine eligibility.
                        </p>
                    </div>
                    ...
                    <div class="relative text-center group">
                        <div
                            class="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-600 text-white flex items-center justify-center text-xl font-bold mb-5 shadow-lg shadow-indigo-500/30 relative z-10 group-hover:scale-110 transition-transform duration-300">
                            3
                        </div>
                    ...
                    <div class="relative text-center group">
                        ...
                        <p class="text-sm text-slate-600 leading-relaxed">An assessor evaluates your submitted evidence.
                        </p>
                    </div>
                    ...
                    <div class="relative text-center group">
                        <div
                            class="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 text-white flex items-center justify-center text-xl font-bold mb-5 shadow-lg shadow-emerald-500/30 relative z-10 group-hover:scale-110 transition-transform duration-300">
                            5
                        </div>
        ...
        <section class="py-20 lg:py-28 bg-slate-50 w-full">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-lg text-slate-600 max-w-2xl mx-auto">Build a strong portfolio to support your
                        application.</p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- Work Experience -->
                    <div
                        class="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div
                        ...
                        <ul class="space-y-3 text-slate-600 text-sm">
                            <li class="flex items-start gap-2">
                                <svg class="w-4 h-4 text-emerald-500 mt-0.5 shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7" />
                                </svg>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3 mb-4 pb-4 border-b border-slate-100">
                            <div class="w-10 h-10 rounded-lg bg-amber-50 text-amber-600 flex items-center justify-center">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909M3 21h18M12 9.75h.008v.008H12V9.75z" />
                                </svg>
                            </div>
        ...
        <section class="py-20 lg:py-28 bg-white w-full">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-lg text-slate-600 max-w-2xl mx-auto">Accelerate your academic journey by leveraging your
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div
                        class="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                        <div
                            class="w-14 h-14 rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 text-white flex items-center justify-center mb-6 shadow-lg shadow-orange-500/25 group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z" />
                            </svg>
                        ...
                        <p class="text-slate-600 leading-relaxed">Get formal, nationally recognised credentials for the
                            skills you already possess.</p>
                    </div>
                    ...
                    <div
                        class="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                        <div
                            class="w-14 h-14 rounded-xl bg-gradient-to-br from-brand-500 to-indigo-600 text-white flex items-center justify-center mb-6 shadow-lg shadow-brand-500/25 group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p class="text-slate-600 leading-relaxed">Unlock promotions, higher salary brackets, and new job
                            opportunities with formal qualifications.</p>
                    </div>
                    ...
                    <div
                        class="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                        <div
                            class="w-14 h-14 rounded-xl bg-gradient-to-br from-emerald-400 to-teal-600 text-white flex items-center justify-center mb-6 shadow-lg shadow-emerald-500/25 group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p class="text-slate-600 leading-relaxed">Save significant time and money by avoiding repetitive
                            study for skills you already know.</p>
                    </div>
                    ...
                    <div
                        class="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                        <div
                            class="w-14 h-14 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 text-white flex items-center justify-center mb-6 shadow-lg shadow-violet-500/25 group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p class="text-slate-600 leading-relaxed">Crucial step for many skilled migration visas requiring
                            formal Australian qualifications.</p>
                    </div>
                </div>
            </div>
        </section>
