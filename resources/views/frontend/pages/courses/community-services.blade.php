            ...
            <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                ...
                <div class="space-y-6 lg:col-span-7">
                    ...
                    <h1 class="text-2xl font-bold leading-tight text-brand-500 sm:text-3xl md:text-4xl lg:text-5xl">
                        CHC52025 Diploma of <br class="hidden sm:block">
                        Community Services
                    </h1>

                    <!-- Description -->
                    <p class="max-w-xl text-base leading-relaxed text-slate-600 sm:text-lg">
                        Build advanced skills and knowledge to deliver, manage and coordinate person-centred community
                        services. CHC52025 is a nationally recognised qualification designed for community service
                        professionals seeking specialised skills, greater responsibility and career progression across a
                        range of community services settings.
                    </p>
            ...
            <div class="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
                ...
                <div class="space-y-8">
                    ...
                    <p class="text-lg leading-relaxed text-slate-600">
                        The <strong>CHC52025 Diploma of Community Services</strong> is designed for community service
                        workers involved in the delivery, management and coordination of person-centred services to
                        individuals, groups and communities. It develops specialised skills for working autonomously,
                        supporting personal and social wellbeing, coordinating services and contributing to positive
                    ...
                    <ul class="space-y-4 max-w-3xl">
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-900">Person-Centred Community Services</h4>
                                <p class="mt-1 text-sm leading-relaxed text-slate-600">Develop advanced skills to
                                    understand individual needs and support people to achieve their personal and social
                                    wellbeing goals.</p>
                            </div>
                        </li>
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-900">Case Management & Support</h4>
                                <p class="mt-1 text-sm leading-relaxed text-slate-600">Build skills in assessing needs,
                                    facilitating case management and coordinating services to support positive client
                                    outcomes.</p>
                            </div>
                        </li>
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-900">Crisis & Risk Response</h4>
                                <p class="mt-1 text-sm leading-relaxed text-slate-600">Develop the knowledge required to
                                    recognise and respond appropriately to crisis situations and complex client needs.</p>
                            </div>
                        </li>
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-900">Community & Social Wellbeing</h4>
                                <p class="mt-1 text-sm leading-relaxed text-slate-600">Understand the social, cultural and
                                    environmental factors that influence people and communities.</p>
                            </div>
                        </li>
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-900">Professional & Ethical Practice</h4>
                                <p class="mt-1 text-sm leading-relaxed text-slate-600">Develop skills in legal and ethical
                                    compliance, cultural safety, professional reflection and workplace wellbeing.</p>
                            </div>
                        </li>
                    </ul>
                    <p>The qualification reflects the role of community service workers who may work autonomously under
                        broad direction and may also supervise other workers and volunteers or undertake case management and
            ...
            <div
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 mt-6">
                    ...
                    <div
                        ...
                        <span class="text-lg font-bold text-slate-900">CHC52025</span>
                    </div>
                    <!-- Duration -->
                    <div
                        class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-200 hover:shadow-lg hover:shadow-brand-500/5">
                    ...
                    <div
                        ...
                        <span class="text-lg font-bold text-slate-900">From $2000</span>
                    </div>
        ...
        <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                ...
                <div
                    ...
                    <p class="leading-relaxed text-slate-600">Develop specialised community services skills for roles
                        across community support, case management, social services and client support environments.</p>
                    <div
                ...
                <div
                    ...
                    <h3 class="mb-4 text-xl font-bold text-slate-900">Advanced Industry Skills</h3>
                    <p class="leading-relaxed text-slate-600">Build practical knowledge in case management, crisis
                        response, service coordination, cultural safety, legal compliance and professional practice.</p>
                    <div
                ...
                <div
                    ...
                    <h3 class="mb-4 text-xl font-bold text-slate-900">Multiple Career Pathways</h3>
                    <p class="leading-relaxed text-slate-600">Develop skills that can support career progression across
                        case management, social housing, child and family welfare, family violence response and broader
                        community services.
                    </p>
                    <div
    ...
    <section class="bg-white py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-16 text-center">
                ...
                <p class="mx-auto max-w-2xl text-lg text-slate-600">CHC52025 can support career opportunities across
                    community services, social support, case management and community-based organisations.</p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Case Manager</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Community Services Worker</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Family Support Worker</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Social Housing Worker</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Case Management Coordinator</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Client Services Coordinator</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Support Coordinator</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Community Development Worker</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Family Services Worker</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Community Care Coordinator</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Social Services Worker</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Intake and Assessment Worker</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Client Support Officer</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div>
                    <div class="mb-6 flex items-center gap-3">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900">Core Units <span
                                class="text-base font-medium text-slate-500">(12)</span></h3>
                    </div>
                    <ul class="space-y-3">
                        <li
                            ...
                            <div><span class="font-bold text-slate-900">CHCCCS004</span><span class="text-slate-600"> —
                                    Assess co-existing needs</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">CHCCCS007</span><span class="text-slate-600"> —
                                    Develop and implement service programs</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">CHCCCS019</span><span class="text-slate-600"> —
                                    Recognise and respond to crisis situations</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">CHCCSM017</span><span class="text-slate-600"> —
                                    Facilitate and review case management</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">CHCDEV005</span><span class="text-slate-600"> —
                                    Analyse impacts of sociological factors on people in community work and services</span>
                            </div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            ...
                            <div><span class="font-bold text-slate-900">CHCDFV001</span><span class="text-slate-600"> —
                                    Recognise and respond appropriately to domestic and family violence</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                        ...
                        <li
                            ...
                            <div><span class="font-bold text-slate-900">CHCDIV002</span><span class="text-slate-600"> —
                                    Promote Aboriginal and/or Torres Strait Islander cultural safety</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                        ...
                        <li
                            ...
                            <div><span class="font-bold text-slate-900">CHCMGT005</span><span class="text-slate-600"> —
                                    Facilitate workplace debriefing and support processes</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                                class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-brand-100 text-xs font-bold text-brand-700">11</span>
                            <div><span class="font-bold text-slate-900">CHCPRP003</span><span class="text-slate-600"> —
                                    Reflect on and improve own professional practice</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                                class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-brand-100 text-xs font-bold text-brand-700">12</span>
                            <div><span class="font-bold text-slate-900">HLTWHS003</span><span class="text-slate-600"> —
                                    Maintain work health and safety</span></div>
                        </li>
                    </ul>
                </div>
                <!-- Elective Units -->
                <div>
                    ...
                    <ul class="space-y-3">
                        <li
                            ...
                            <div><span class="font-bold text-slate-900">CHCCSM009</span><span class="text-slate-600"> —
                                    Facilitate goal-directed planning</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-amber-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">CHCCSM012</span><span class="text-slate-600"> —
                                    Coordinate complex case requirements</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-amber-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">CHCCSM014</span><span class="text-slate-600"> —
                                    Provide case management supervision</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-amber-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">CHCCSM015</span><span class="text-slate-600"> —
                                    Undertake case management in a child protection framework</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-amber-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">CHCMGT003</span><span class="text-slate-600"> —
                                    Lead the work team</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-amber-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">CHCCCS009</span><span class="text-slate-600"> —
                                    Facilitate responsible behaviour</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-amber-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">BSBPEF401</span><span class="text-slate-600"> —
                                    Manage personal health and wellbeing</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-amber-200 hover:bg-white hover:shadow-md">
                            <span
        ...
        <div class="space-y-4">
            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    What is CHC52025 Diploma of Community Services?
                ...
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    CHC52025 is a nationally recognised qualification for community service workers involved in delivering, managing and coordinating person-centred services to individuals, groups and communities.
                </div>
            </details>

            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    Is CHC52025 nationally recognised?
                    <span class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                </summary>
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    Yes. CHC52025 is a current qualification listed on the Australian Government's national training register.
                </div>
            </details>

            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    How many units are in CHC52025?
                    <span class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                </summary>
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    There are 20 units in total: 12 core units and 8 elective units.
                </div>
            </details>

            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    Does CHC52025 have entry requirements?
                    <span class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                </summary>
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    The national qualification has no formal entry requirements. However, individual training providers may have enrolment, LLN or suitability requirements.
                </div>
            </details>

            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    Can I complete CHC52025 through RPL?
                    <span class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                </summary>
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    Yes. Students with relevant community services experience, previous training and workplace evidence may be eligible for Recognition of Prior Learning.
                </div>
            </details>
            ...
            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                ...
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    Recognition of Prior Learning assesses your existing skills, knowledge and experience against the requirements of the qualification. Where competency can be demonstrated, you may not need to repeat training for those skills.
                </div>
            </details>

            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    Do I need previous community services experience?
                    <span class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                </summary>
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    Previous experience is not a formal entry requirement for CHC52025. However, relevant industry experience can be particularly valuable for students applying through RPL.
                </div>
            </details>
            ...
            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                ...
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    Yes. To achieve CHC52025, candidates must complete at least 100 hours of work as detailed in the assessment requirements of the units.
                </div>
            </details>

            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    What jobs can I get after completing CHC52025?
                    <span class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                </summary>
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    Potential career outcomes include Case Manager, Community Services Worker, Community Support Worker, Family Support Worker, Social Housing Worker, Support Coordinator, Client Services Coordinator and Community Program Coordinator.
                </div>
            </details>

            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    Can CHC52025 help me progress into case management?
                    <span class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                </summary>
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    Yes. The qualification includes CHCCSM017 – Facilitate and review case management as a core unit and provides an elective pathway specifically focused on case management.
                </div>
            </details>

            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    Does CHC52025 have specialisations?
                    <span class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                </summary>
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    Yes. The current qualification allows electives to be packaged into specialisations including: Case Management, Social Housing, Child, Youth and Family Welfare, Responding to Family Violence. The number of required Group A, B, C or D electives varies depending on the specialisation.
                </div>
            </details>

            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    What is the Case Management specialisation?
                    <span class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                </summary>
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    The Case Management specialisation requires at least 4 Group A electives to be selected as part of the qualification.
                </div>
            </details>

            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    Can I complete CHC52025 through RPL if I already work in community services?
                    <span class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                </summary>
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    Yes. Your existing workplace skills and experience can potentially be assessed through RPL. You may be required to provide employment evidence, workplace documents, previous qualifications and other evidence of competency.
                </div>
            </details>

            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    Is there a pathway after the Diploma of Community Services?
                    <span class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                </summary>
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    Yes. CHC52025 can provide a foundation for further study and career progression across community services, social services, case management and related fields. Specific credit or pathway arrangements depend on the subsequent qualification and training provider.
                </div>
            </details>

            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    Does CHC52025 have licensing requirements?
                    <span class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                </summary>
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    No licensing, legislative or certification requirements apply to the qualification at the time of publication. Individual employers, organisations or workplaces may nevertheless have additional requirements or screening processes.
                </div>
            </details>
            ...
            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                ...
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    Depending on the employer or placement provider, students may need to provide documentation such as a National Police Check, Working with Children Check where applicable, worker screening clearance or other workplace-specific requirements.
                </div>
            </details>
            ...
            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                ...
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    CHC52025 is suitable for people seeking to develop or advance their careers in community services, including community support workers, case management workers, family support workers, social housing workers, client service workers and professionals seeking greater responsibility in community service environments.
                </div>
            </details>

            <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                <summary class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                    Is CHC52025 the replacement for CHC52021?
                    <span class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                </summary>
                <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                    Yes. CHC52025 supersedes and is equivalent to CHC52021 Diploma of Community Services, with the current version introducing changes including updated core units and a reduction in the mandatory work placement requirement from 160 hours to 100 hours.
                </div>
            </details>
        </div>
    </div>
