...
@section('content')
    ...
    <section class="relative flex min-h-[50vh] items-center overflow-hidden bg-white">
        ...
        <div class="absolute inset-0">
            ...
            <div class="absolute inset-0 bg-linear-to-r from-white via-white/95 to-white/70"></div>
        </div>
            ...
            <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                ...
                <div class="space-y-6 lg:col-span-7">
                    ...
                    <p class="max-w-xl text-base leading-relaxed text-slate-600 sm:text-lg">
                        Build advanced project management skills and knowledge to initiate, plan, execute, monitor and
                        evaluate projects across a range of industries. BSB50820 is a nationally recognised qualification
                        designed for professionals seeking to develop their project leadership, management and coordination
                        capabilities.</p>
            ...
            <div class="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
                ...
                <div class="space-y-8">
                    ...
                    <p class="text-lg leading-relaxed text-slate-600">
                        The <strong>BSB50820 Diploma of Project Management</strong> is designed for individuals who apply
                        specialised project management skills across a range of industries and project environments. The
                        qualification develops practical capabilities in project scope, time, cost, quality, risk,
                        resources, communication and project integration.
                    ...
                    <ul class="space-y-4 max-w-3xl">
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-900">Project Planning & Scope </h4>
                                <p class="mt-1 text-sm leading-relaxed text-slate-600"> Develop the skills required to
                                    define project scope, establish objectives and manage project requirements effectively.
                                </p>
                            </div>
                        </li>
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-900">Time & Cost Management</h4>
                                <p class="mt-1 text-sm leading-relaxed text-slate-600">Build skills to develop project
                                    schedules, manage budgets and monitor project performance against agreed timelines and
                                    costs.</p>
                            </div>
                        </li>
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-900">Quality & Risk Management </h4>
                                <p class="mt-1 text-sm leading-relaxed text-slate-600"> Learn how to establish quality
                                    processes, identify project risks and implement appropriate risk management strategies.
                                </p>
                            </div>
                        </li>
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-900">Project Resources & Teams</h4>
                                <p class="mt-1 text-sm leading-relaxed text-slate-600">Develop skills to manage project
                                    human resources and coordinate people and resources to achieve project objectives.</p>
                            </div>
                        </li>
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-900">Communication & Integration</h4>
                                <p class="mt-1 text-sm leading-relaxed text-slate-600"> Build the ability to manage project
                                    information, communication and integration across different project activities and
                                    stakeholders.
                                </p>
                            </div>
                        </li>
                    </ul>
                    <p> The qualification reflects the role of individuals who apply project management skills and knowledge
                        in a variety of contexts and across a number of industry sectors. Potential job roles include
                        Project Manager and Project Team Leader.
                    </p>
                </div>
    ...
    <section class="relative overflow-hidden bg-white py-24">
        ...
        <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div
                ...
                {{-- <div class="absolute top-0 left-0 h-1 w-full bg-linear-to-r from-brand-500 to-violet-500"></div> --}}
                <div class="mb-6 flex items-center justify-center gap-4">
                    <div
                        class="flex w-10 h-10 md:w-12 md:h-12 lg:h-14 lg:w-14 items-center justify-center rounded-2xl bg-linear-to-br from-brand-500 to-violet-600 shadow-lg shadow-brand-500/20 transition-transform duration-300 group-hover:scale-110">
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 mt-6">
                    ...
                    <div
                        ...
                        <span class="text-lg font-bold text-slate-900">BSB50820 </span>
                    </div>
                    <!-- Duration -->
                    <div
                        class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-200 hover:shadow-lg hover:shadow-brand-500/5">
                    ...
                    <div
                        ...
                        <span class="text-lg font-bold text-slate-900">$2000</span>
                    </div>
        ...
        <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                ...
                <div
                    ...
                    <div
                        class="mx-auto mb-6 flex w-10 h-10 md:w-12 md:h-12 lg:h-16 lg:w-16 items-center justify-center rounded-2xl bg-linear-to-br from-brand-500 to-violet-600 shadow-lg shadow-brand-500/20 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-[-3deg]">
                    ...
                    <h3 class="mb-4 text-xl font-bold text-slate-900">Advance Your Project Management Career</h3>
                    <p class="leading-relaxed text-slate-600">Develop the specialised skills and knowledge needed to
                        progress into project management, project leadership and coordination roles.</p>
                    <div
                        class="absolute bottom-0 left-1/2 h-0.5 w-0 -translate-x-1/2 rounded-full bg-linear-to-r from-transparent via-brand-500 to-transparent transition-all duration-500 group-hover:w-3/5">
                    </div>
                </div>
                ...
                <div
                    ...
                    <div
                        class="mx-auto mb-6 flex w-10 h-10 md:w-12 md:h-12 lg:h-16 lg:w-16 items-center justify-center rounded-2xl bg-linear-to-br from-emerald-500 to-teal-600 shadow-lg shadow-emerald-500/20 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-[-3deg]">
                    ...
                    <h3 class="mb-4 text-xl font-bold text-slate-900">Develop Practical Project Skills</h3>
                    <p class="leading-relaxed text-slate-600">Build capabilities in project scope, scheduling, cost,
                        quality, risk, human resources, communication and project integration.</p>
                    <div
                        class="absolute bottom-0 left-1/2 h-0.5 w-0 -translate-x-1/2 rounded-full bg-linear-to-r from-transparent via-emerald-500 to-transparent transition-all duration-500 group-hover:w-3/5">
                    </div>
                </div>
                ...
                <div
                    ...
                    <div
                        class="mx-auto mb-6 flex w-10 h-10 md:w-12 md:h-12 lg:h-16 lg:w-16 items-center justify-center rounded-2xl bg-linear-to-br from-amber-500 to-orange-600 shadow-lg shadow-amber-500/20 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-[-3deg]">
                        <svg class="md:h-7 md:w-7 w-5 h-5 text-white" fill="none" stroke="currentColor"
                            stroke-width="1.8" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <p class="leading-relaxed text-slate-600">Use the qualification as a foundation for progressing into
                        project management roles across business, construction, IT, community services, government and other
                        industries.
                    </p>
                    <div
                        class="absolute bottom-0 left-1/2 h-0.5 w-0 -translate-x-1/2 rounded-full bg-linear-to-r from-transparent via-amber-500 to-transparent transition-all duration-500 group-hover:w-3/5">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Project Manager</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Project Team Leader</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            ...
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M2.25 12.75V11.25A2.25 2.25 0 014.5 9h15a2.25 2.25 0 012.25 2.25v1.5m-17.25 0h17.25M2.25 12.75V17.25A2.25 2.25 0 004.5 19.5h15a2.25 2.25 0 002.25-2.25v-4.5m-17.25 0h17.25" />
                            </svg>
                        </div>
                        <h4 class="text-base font-bold text-slate-900">Project Administrator</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Project Officer</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Project Support Officer</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Project Scheduler</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Project Planner</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Project Management Coordinator</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Program Support Officer</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Project Contract Manager</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Project Vendor Manager</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Industry-Specific Project Manager</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        <div
                            ...
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.324.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 011.37.49l1.296 2.247a1.125 1.125 0 01-.26 1.431l-1.003.827c-.293.24-.438.613-.431.992a6.759 6.759 0 010 .255c-.007.378.138.75.43.99l1.005.828c.424.35.534.954.26 1.43l-1.298 2.247a1.125 1.125 0 01-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.57 6.57 0 01-.22.128c-.331.183-.581.495-.644.869l-.212 1.28c-.09.543-.56.941-1.11.941h-2.594c-.55 0-1.02-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 01-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 01-1.369-.49l-1.297-2.247a1.125 1.125 0 01.26-1.431l1.004-.827c.292-.24.437-.613.43-.992a6.932 6.932 0 010-.255c.007-.378-.138-.75-.43-.99l-1.004-.828a1.125 1.125 0 01-.26-1.43l1.297-2.247a1.125 1.125 0 011.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.087.22-.128.332-.183.582-.495.644-.869l.214-1.281zM15 14.25a3 3 0 11-6 0 3 3 0 016 0z" />
                            </svg>
                        </div>
                        <h4 class="text-base font-bold text-slate-900">Project Operations Coordinator</h4>
                    </div>
                </div>
                <div
                    class="group flex rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5 lg:p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-lg hover:shadow-brand-500/5">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="text-base font-bold text-slate-900">Senior Project Coordinator</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
                ...
                <div>
                    <div class="mb-6 flex items-center gap-3">
                        <div
                            class="flex h-10 w-10 items-center justify-center rounded-xl bg-linear-to-br from-brand-500 to-violet-600 shadow-lg shadow-brand-500/20">
                    ...
                    <ul class="space-y-3">
                        <li
                            ...
                            <div><span class="font-bold text-slate-900">BSBPMG530</span><span class="text-slate-600"> —
                                    Manage project scope</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">BSBPMG531</span><span class="text-slate-600"> —
                                    Manage project time</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">BSBPMG532</span><span class="text-slate-600"> —
                                    Manage project quality</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">BSBPMG533</span><span class="text-slate-600"> —
                                    Manage project cost</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">BSBPMG534</span><span class="text-slate-600"> —
                                    Manage project human resources</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">BSBPMG535</span><span class="text-slate-600"> —
                                    Manage project information and communication</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">BSBPMG536</span><span class="text-slate-600"> —
                                    Manage project risk</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white hover:shadow-md">
                            <span
                            ...
                            <div><span class="font-bold text-slate-900">BSBPMG540</span><span class="text-slate-600"> —
                                    Manage project integration</span></div>
                        </li>
                    </ul>
                </div>
                <!-- Elective Units -->
                <div>
                    <div class="mb-6 flex items-center gap-3">
                        <div
                            class="flex h-10 w-10 items-center justify-center rounded-xl bg-linear-to-br from-amber-500 to-orange-600 shadow-lg shadow-amber-500/20">
                            <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <h3 class="text-2xl font-bold text-slate-900">Elective Units <span
                                class="text-base font-medium text-slate-500">(4)</span></h3>
                    </div>
                    <ul class="space-y-3">
                        <li
                            ...
                            <div><span class="font-bold text-slate-900">BSBLDR601</span><span class="text-slate-600"> —
                                    Lead and manage organisational change</span></div>
                        </li>
                        <li
                            class="group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-amber-200 hover:bg-white hover:shadow-md">
                            <span
        ...
        <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1">
                ...
                <div
                    ...
                    {{-- <div class="absolute top-0 left-0 h-1 w-full bg-linear-to-r from-violet-500 to-purple-500"></div> --}}
                    <div class="mb-6 flex  gap-4">
                        <div
                            class="flex w-10 h-10 md:w-12 md:h-12 lg:h-14 lg:w-14 items-center justify-center shrink-0 rounded-2xl bg-linear-to-br from-violet-500 to-purple-600 shadow-lg shadow-violet-500/20 transition-transform duration-300 group-hover:scale-110">
                            <svg class="h-5 w-5 md:h-7 md:w-7 text-white" fill="none" stroke="currentColor"
                                stroke-width="1.8" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z" />
            ...
            <div class="space-y-4">
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        ...
                        What is BSB50820 Diploma of Project Management?
                        <span
                    ...
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        BSB50820 is a nationally recognised qualification designed for individuals who apply specialised
                        project management skills and knowledge across a range of industries and project environments.
                    </div>
                </details>
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                        Is BSB50820 nationally recognised?
                        <span
                            class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                    </summary>
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        Yes. BSB50820 is a nationally recognised Australian qualification listed on the Australian
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                        How many units are in BSB50820?
                        <span
                            class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                    </summary>
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        There are 12 units in total: 8 core units and 4 elective units.
                    </div>
                </details>
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                        Does BSB50820 have entry requirements?
                        <span
                            class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                    </summary>
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                        Can I complete BSB50820 through RPL?
                        <span
                            class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                    </summary>
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        Yes. Individuals with relevant project management, project coordination or workplace experience may
                        be eligible for Recognition of Prior Learning.
                    </div>
                </details>
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    ...
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        Previous project management experience is not a formal entry requirement for BSB50820. However,
                        relevant workplace experience can be particularly valuable for students undertaking RPL.
                    </div>
                </details>
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    ...
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        The qualification develops skills in project scope, time, cost, quality, human resources,
                        information and communication, risk management and project integration.
                    </div>
                </details>
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                        What jobs can I get after completing BSB50820?
                        <span
                            class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                    </summary>
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        Potential career outcomes include Project Manager, Project Team Leader, Project Coordinator, Project
                        Administrator, Project Officer, Project Support Officer, Project Scheduler and Project Planner.
                    </div>
                </details>
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                        Can BSB50820 help me become a Project Manager?
                        <span
                            class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                    </summary>
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        Yes. BSB50820 is specifically designed around project leadership and management and can support
                        progression into project management roles across a range of industries.
                    </div>
                </details>
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                        Can I complete BSB50820 through RPL if I already manage projects?
                        <span
                            class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                    </summary>
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        Yes. Your existing project management skills and workplace experience may be assessed through RPL.
                        You may need to provide project documentation, employment evidence, previous qualifications and
                        other evidence demonstrating your competency.
                    </div>
                </details>
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    ...
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        BSB50820 does not specify a qualification-wide mandatory work-placement requirement in its packaging
                        rules. However, individual units may require project management skills to be demonstrated in a
                        workplace or simulated workplace environment, depending on the applicable assessment requirements.
                    </div>
                </details>
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                        What industries can I work in after completing BSB50820?
                        <span
                            class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                    </summary>
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        Project management skills can be applied across many industries, including business, construction,
                        information technology, government, education, community services, events, engineering and
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                        Can BSB50820 help with career progression?
                        <span
                            class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                    </summary>
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        Yes. The qualification can support progression from project support and coordination positions into
                        project leadership and project management roles.
                    </div>
                </details>
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                        Is there a pathway after the Diploma of Project Management?
                        <span
                            class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                    </summary>
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        Yes. BSB50820 can provide a foundation for further study in project management, program management,
                        business and related disciplines. Specific credit or pathway arrangements depend on the subsequent
                        qualification and training provider.
                    </div>
                </details>
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                        Does BSB50820 have licensing requirements?
                        <span
                            class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                    </summary>
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        No licensing, legislative or certification requirements apply to BSB50820 at the time of
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    ...
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        BSB50820 is suitable for project coordinators, project administrators, team leaders, supervisors,
                        business professionals and individuals seeking to develop formal project management skills or
                        progress into project leadership roles.
                    </div>
                </details>
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                        What is the difference between BSB40920 and BSB50820?
                        <span
                            class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                    </summary>
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        BSB40920 Certificate IV in Project Management Practice focuses on practical project support and
                        project management skills, while BSB50820 Diploma of Project Management develops a higher level of
                        specialised project leadership and management capability. The Diploma is designed for roles such as
                        Project Manager and Project Team Leader.
                    </div>
                </details>
                ...
                <details class="bg-surface-container-lowest border border-outline-variant/30 rounded-lg group">
                    <summary
                        class="font-headline-md text-lg text-on-surface p-6 cursor-pointer flex justify-between items-center">
                        Is BSB50820 equivalent to the previous Diploma of Project Management?
                        <span
                            class="material-symbols-outlined transform group-open:rotate-180 transition-transform">expand_more</span>
                    </summary>
                    <div class="p-6 pt-4 font-body-md text-on-surface-variant border-t border-outline-variant/20 mt-2">
                        Yes. BSB50820 supersedes and is equivalent to BSB51415 Diploma of Project Management.
                    </div>
                </details>
            </div>
        </div>
