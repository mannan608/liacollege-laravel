                        ...
                        <div id="default-tab-content">
                            ...
                            <div class="hidden p-3 md:p-4 rounded-xl border border-brand-500" id="overview" role="tabpanel"
                                ...
                                <p class="text-sm md:text-base leading-7 text-neutral-600 mb-3">
                                    ...
                                    skills, together with experience in leadership and management, across a range of
                                    enterprise and industry contexts.
                                </p>
                                <p class="text-sm md:text-base leading-7 text-neutral-600">
                                    Individuals at this level use initiative and judgement to plan and implement a range of
                                    leadership and management functions, with accountability for personal and team outcomes
                                    within broad parameters.
                                </p>
                                <p class="text-sm md:text-base leading-7 text-neutral-600">
                                    They use cognitive and communication skills to identify, analyse and synthesise
                                    information from a variety of sources and transfer their knowledge to others, and
                                    creative or conceptual skills to express ideas and perspectives or respond to complex
                                    problems.
                                </p>
                            ...
                            <div class="hidden p-3 md:p-4 rounded-xl border border-brand-500" id="entry-requirements"
                                ...
                                <ul class="list-disc pl-5 space-y-0.5 text-gray-600 text-sm md:text-base mb-3">
                                    ...
                                    <li> Have completed a Diploma or Advanced Diploma from the BSB Training Package (current
                                        or superseded equivalent versions). or Have two years equivalent full-time relevant
                                        workplace experience in an operational or leadership role in an enterprise.</li>
                                </ul>
                                <p class="text-sm md:text-base leading-7 text-neutral-600">
                                    Our <a href="https://www.skwatches.com/" class="text-brand-500">fake rolex</a> watches
                                    offer an affordable alternative to genuine Rolex timepieces
                                    without compromising on quality. While we use the term “fake” for search purposes, our
                                    replicas are actually high-quality reproductions crafted with precision and care. Each
                                    watch mirrors the design and functionality of authentic Rolex models, from the weight
                                    and balance to the smooth movement operation. We take pride in offering replicas that
                                    even experienced watch enthusiasts find impressive. Browse our collection to discover
                                    why our “fake” Rolex watches are considered among the best in the industry.
                                </p>
                            </div>
