                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div class="min-w-0">
                                                    ...
                                                    <p class="mt-1 text-xs text-slate-500">
                                                        {{ $category->sections->count() }} Sections
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="divide-y divide-slate-200">
                                            @foreach ($category->sections as $section)
                                                <div class="border-b border-slate-200">
                                                    <div class="bg-slate-50 px-4 py-3 sm:px-5">
                                                        <div class="flex items-center gap-3">
                                                            <div
                                                                class="flex h-9 w-9 items-center justify-center rounded-lg bg-white text-brand-600 shadow-sm">
                                                            ...
                                                            <h4 class="text-base font-semibold text-slate-800 sm:text-lg lg:text-xl">
                                                            ...
                                                            <div @class([
                                                                ...
                                                                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                                                                    <div @class([
                                                                        ...
                                                                        @else
                                                                            <span class="text-sm md:text-base lg:text-lg text-gray-500 leading-relaxed font-medium line-clamp-1">
                                                                                {{ $row->data['text'] ?? '' }}
                                                                            </span>
                                                                        @endif
                                                                    </div>
