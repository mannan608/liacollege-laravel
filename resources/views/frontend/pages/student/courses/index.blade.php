                    ...
                    <tr class="transition hover:bg-gray-50 dark:hover:bg-white/5">
                        ...
                        <td class="px-6">
                            ...
                            <div class="flex justify-end gap-3">
                                ...
                                <button
                                    class="rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
