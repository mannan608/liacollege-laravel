    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-950">
        <div class="max-w-7xl mx-auto px-6 py-8">
            ...
            <nav class="flex items-center gap-2 text-sm mb-8">
                ...
                <svg class="w-4 h-4 text-gray-300 dark:text-gray-700" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <polyline points="9 18 15 12 9 6" />
                </svg>
                <span class="font-medium text-gray-800 dark:text-white">{{ $course->name }}</span>
            </nav>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6 mb-8">
                <h3 class="text-[15px] font-medium text-gray-900 dark:text-white mb-3 flex items-center gap-2.5">
                    <span
                        class="w-7 h-7 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-500 dark:text-gray-400">
                        <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
            ...
            <!-- Learning Material -->
            <div
                class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden mb-8">
                <div
                    class="px-6 py-4 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-950 flex items-center justify-between">
            ...
            <div class="mb-8">
                ...
                <div class="inline-flex bg-gray-100 dark:bg-gray-800 rounded-xl p-1 mb-6">
                    <button onclick="switchTab(0)" id="tab-cal"
                        class="tab-btn-sched active px-6 py-2.5 rounded-lg text-sm font-medium transition-all flex items-center gap-2">
                    ...
                    <button onclick="switchTab(1)" id="tab-list"
                        class="tab-btn-sched px-6 py-2.5 rounded-lg text-sm font-medium transition-all flex items-center gap-2">
                        <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                            <line x1="8" y1="6" x2="21" y2="6" />
                            <line x1="8" y1="12" x2="21" y2="12" />
                ...
                <!-- Calendar Tab -->
                <div id="calendar-tab"
                    class="tab-content-sched bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
                    <div class="text-center py-12 text-sm text-gray-400">
                        <svg class="w-12 h-12 mx-auto mb-3 text-gray-300 dark:text-gray-700" viewBox="0 0 24 24"
                ...
                <!-- List Tab -->
                <div id="list-tab"
                    class="tab-content-sched hidden bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="inline-flex items-center px-2.5 py-1 rounded-md bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 text-xs font-medium">Confirmed</span>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <button
                                        class="text-xs font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">Details</button>
                                </td>
                            </tr>
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="inline-flex items-center px-2.5 py-1 rounded-md bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-400 text-xs font-medium">Pending</span>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <button
                                        class="text-xs font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">Details</button>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="inline-flex items-center px-2.5 py-1 rounded-md bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 text-xs font-medium">Scheduled</span>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <button
                                        class="text-xs font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">Details</button>
            ...
            <!-- Course Modules -->
            <div class="mb-12">
                <h4 class="text-[20px] font-medium text-gray-900 dark:text-white mb-3">Course Modules</h4>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                <span
                                    class="inline-flex items-center px-2.5 py-1 rounded-md bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 text-xs font-medium">COMPLETE</span>
                                <span class="font-medium text-gray-900 dark:text-white">HLTAID011 Provide First Aid</span>
                            </div>
                            <button
                                class="px-4 py-2 text-xs font-medium border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 rounded-lg transition-colors text-gray-700 dark:text-gray-300">
                                Unit Material
                            </button>
                        </div>
                        ...
                        <table class="w-full text-sm">
                            <thead class="bg-gray-50 dark:bg-gray-950 border-b border-gray-200 dark:border-gray-800">
                                <tr>
                                    <th class="text-left pl-6 py-4 font-medium text-gray-500 dark:text-gray-400">Module
                                    </th>
                                    ...
                                    <th class="text-right pr-6 py-4 font-medium text-gray-500 dark:text-gray-400">Action
                                    </th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                @foreach ($course->modules as $module)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                        ...
                                        <td class="pr-6 text-right">
                                            <a href="{{ route('student.course-module', [
                                                'course' => $course->id,
                                                'module' => $module->id,
                                            ]) }}"
                                            class="px-5
