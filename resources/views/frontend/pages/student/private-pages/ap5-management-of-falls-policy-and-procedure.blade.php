                ...
                <div class="et_pb_module et_pb_post_content et_pb_post_content_0_tb_body">
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-bordered mb-0" style="min-width: 760px;">
                            <tbody>
                                <tr>
                                    <td width="114"><strong>Term</strong></td>
                                    <td width="528"><strong>Meaning</strong></td>
                                </tr>
                                <tr>
                                    <td width="114">Falls Prevention</td>
                                    <td width="528">Falls prevention is a systematic approach to reducing the risk and
                                        severity of falls through assessment, interventions, assistive devices and
                                        procedures.
                                    </td>
                                </tr>
                                <tr>
                                    <td width="114">FRAT</td>
                                    <td width="528">FRAT stands for Falls Risk Assessment Tool, a standard tool used in
                                        the
                                        industry to assess a client’s risk of falls and to plan interventions and strategies
                                        to
                                        reduce risk.</td>
                                </tr>
                                <tr>
                                    <td width="114">Gait</td>
                                    <td width="528">Gait refers to the pattern and balance of a person’s steps when
                                        walking.
                                    </td>
                                </tr>
                                <tr>
                                    <td width="114">Intervention</td>
                                    <td width="528">An intervention is a therapeutic procedure or treatment strategy
                                        designed
                                        to support optimal health and wellbeing outcomes for the person.</td>
                                </tr>
                                <tr>
                                    <td width="114">Multifactorial</td>
                                    <td width="528">Multifactorial approaches combine allied health services, medical
                                        intervention, assistive devices, environmental adaptations, exercise, technology and
                                        human systems to create the best possible approach to supporting the person.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <p>Upon initial intake, every client will be assessed using the Falls Risk Assessment Tool to provide a
                        comprehensive and multifactorial falls risk assessment.</p>
                    <p>This will be reviewed annually and after any fall or change in the resident’s health status.</p>
                    <p>The Falls Risk Assessment includes an assessment of the client’s gait, balance, posture, mobility,
                    ...
                    <p>A multidisciplinary team will review each client’s FRAT on submission. This team will include, at a
                        minimum, the Care Coordinator, the Nurse, the client’s GP and a support worker. Where necessary,
                        other allied health professionals will participate in the FRAT review. This team will determine a
                        system of risk reductions, including:</p>
                    <ul>
                        <li>environmental modifications</li>
                        <li>assistive devices</li>
                        <li>Allied Health interventions, such as physiotherapy</li>
                        <li>changes to the timing, type or dosage of medication if the medication has a proven increased
                            risk effect (must be authorised by GP)</li>
                        <li>human systems such as the timing or location of meals, bathing, toileting, frequency of changes
                            of incontinence pads and daily exercise routines.</li>
                    </ul>
                    <h3><span style="color: #fcb53b;">Post Falls Procedure</span></h3>
                    ...
                    <ul>
                        ...
                        <li>First responders will stay with the client, talking with them and reassuring them, even if they
                            appear unconscious.</li>
                        <li>Qualified medical personnel attending the fall will perform a physical assessment of the
                            resident at the time of the fall, including vital signs (which may include orthostatic blood
                            pressure readings) and an evaluation of head, neck, spine and/or extremity injuries. Vital signs
                            should be repeated every hour for the first four hours after the fall. Vital signs should then
                            be monitored every four hours for the first 24 hours after the fall.</li>
                        <li>Neurological observations (Glasgow Coma Scale (GCS)) must be commenced if there are any signs of
                        ...
                        <li>A multidisciplinary care team, including a nurse, support worker, the client’s GP and relevant
                            Allied Health professionals, will design and implement a Post Fall Care Plan to ensure optimal
                            recovery of the client’s physiological and psychological wellbeing and confidence after the
                            fall.</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>If they experience any of the following symptoms: numbness or tingling in the hands and feet,
                            loss of balance, vertigo, blood pressure issues, unusual lack of sleep, any loss of
                            consciousness.</li>
                    </ul>
                    <p>A client will be referred to a psychologist if, after a fall, they experience any symptoms of
                        depressive illness or anxiety lasting for more than one month after the fall.</p>
                    <ul></ul>
                    <h3><span style="color: #fcb53b;">Rights and Responsibilities of Managers</span></h3>
                    <p>Frank Brookes (Care Coordinator) is responsible for managing the systematic implementation of all
                        FRATs for each client, including managing the FRAT upon intake and the annual review cycle for<br>
                        each client.</p>
                    <p>Heather Brinkley (Nurse) is responsible for coordinating post-fall responses for clients, including
                        organising the multidisciplinary FRAT review and Post Fall Care Plan within 48 hours after a fall.
                    </p>
                    <ul></ul>
                    ...
                    <p>The Aged Care Quality and Safety Commission may be contacted concerning legislative requirements and
                        in cases of serious breaches of this policy and procedure.</p>
