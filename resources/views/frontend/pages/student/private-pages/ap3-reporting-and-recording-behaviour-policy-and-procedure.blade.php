...
@section('content')
    ...
    <table class="table table-bordered mb-0" style="min-width: 760px;">
                        <thead>
                            <tr>
                                <td width="123"><strong>Term</strong></td>
                                <td width="359"><strong>Meaning</strong></td>
                                <td width="160"><strong>Source</strong></td>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td width="123">Behaviours of concern</td>
                                <td width="359">The behaviour of concern, also termed challenging behaviour, refers to
                                    challenging and difficult behaviors exhibited by people with a disability that impact
                                    their physical safety or quality of life and/or those around them.<p></p>
                                ...
                                <td width="160"><a
                                        href="https://www.elvescare.com.au/behaviour-%20of-concern/">https://www.elvescare.com.au/behaviour-
                                        of-concern/</a></td>
                            </tr>
                            <tr>
                                <td width="123">Behaviour Support Plan (BSP)</td>
                                <td width="359">BSP – is for any resident that requires behaviour support by a provider
                                    ...
                                    them and their care partners.<p></p>
                                ...
                                <td width="160">https://www.dementia.com.au/behaviour- support-plans</td>
                            </tr>
                            <tr>
                                <td width="123">Emergency situation</td>
    ...
    <table class="table table-bordered mb-0" style="min-width: 760px;">
                        <tbody>
                            <tr>
                                <td width="170"><strong>Policy Created/ Reviewed</strong></td>
                                <td width="312"><strong>Modifications</strong></td>
                                <td width="160"><strong>Next Review Date</strong></td>
                            </tr>
                            <tr>
                                <td width="170">Implemented July 2022</td>
                                <td width="312"></td>
                    ...
                    <h3><span style="color: #fcb53b;">Positive behaviour support strategies which may reduce behaviours of
                            concern</span></h3>
                    <p>When a resident has a well-structured, nurturing and engaging lifestyle with an effective way to
                        ...
                        person-centred approach and reducing the resident from exhibiting behaviours of concern:</p>
                    <ul></ul>
                    <h4><span style="color: #b67318;">Reinforcement</span></h4>
                    <p>Positive reinforcement should occur when the behaviour exhibited by the resident is appropriate at
                        ...
                        to keep them encouraged and actively engaged.</p>
                    <p>Reinforcement will be the most effective in encouraging appropriate behaviour when given immediately
                        to the resident after the appropriate behaviour. As the behaviour is learned, the reinforcement
                        should then be given every now and again.</p>
                    <ul></ul>
                    <h4><span style="color: #b67318;">Teaching new skills</span></h4>
                    <p>By arranging the resident’s environment with objects and materials that promote engagement, the
                        ...
                        can be used when teaching new skills, as follows:</p>
                    <ul>
                    ...
                    <h4><span style="color: #b67318;">Teaching coping skills</span></h4>
                    <p>Everyone uses a specific set of skills to cope with different situations when presented to them. Your
                        residents may need support in coping with changes to the service, waiting or noisy environments.</p>
                    <p>The employee can prompt the resident to use different coping skills, such as using their iPad or
                        looking at a magazine when waiting for the doctor. Another could be reminding the resident to relax
                        by breathing slowly when they are feeling agitated in the situation.</p>
                    <p>Another positive coping skill is to encourage the resident to express how they feel using verbal cues
                        ...
                        emotions depicted in books.</p>
                    <h4><span style="color: #b67318;">Active listening</span></h4>
                    <p>The employee should stop what they are doing and listen to the resident if appropriate and safe to do
                        so. This involves the employee observing the resident’s body language for cues.</p>
                    <p>If the resident is speaking, listen and remain silent and do not interrupt them or tell them they are
                        wrong.</p>
                    <p>Ask clarifying questions when you are not understanding or have trouble following what the resident
                        ...
                        been said.</p>
                    <p>If a resident is upset, listen for feelings. The resident may not be able to describe the correct
                        ...
                        okay to feel that way”.</p>
                    <p>Once you have reached this point, after the resident has begun to calm down, ask them what they would
                        like you to do. It may be just to listen; it may be to help them cope with their current feelings or
                        perhaps set a goal for change or problem solve the situation with them.</p>
                    <h4><span style="color: #b67318;">Problem solving</span></h4>
                    <p>Problem solving has many different steps that residents can utilise to be more independent. These
                        steps may help the resident identify, and problem solve with or without your assistance:</p>
                    <ol>
                    ...
                    <h4><span style="color: #b67318;">Redirection</span></h4>
                    <p>Ensure that the employee can get the resident’s attention before the behaviour escalates and becomes
                        ...
                        get their attention by redirecting to: “how about we watch that movie you like.”</p>
                    <h4><span style="color: #b67318;">Empowering</span></h4>
                    <p>The employee can provide the resident with the support and information they require to make their own
                        choice and decision.</p>
                    <h4><span style="color: #b67318;">When behaviours of concern arise</span></h4>
                    <p>If it is an emergency situation, the employee should call their supervisor, or where necessary, call
                        triple 0 (000) for assistance. The employee is to stay where they can monitor the resident’s safety
                        until the assistance arrives.</p>
                    <p>If a resident is displaying behaviours or concerns, the employee needs to use their judgement to
                        ...
                        strategies to use. In the case of no BSP available, the following strategies can be used:</p>
                    <p>Taking care not to put themselves at risk of harm, the employee should use the following steps:</p>
                    <ol>
                    ...
                    <h4><span style="color: #b67318;">Reporting and recording requirements</span></h4>
                    <ul>
                    ...
                    <h4><span style="color: #b67318;">Post-incident management of employees, residents and others</span>
                    </h4>
                    <ul>
