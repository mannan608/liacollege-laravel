...
@section('content')
        ...
        <div class="private-page py-5">
            ...
            <div class="">
                ...
                <div class="et_pb_module et_pb_post_content et_pb_post_content_0_tb_body">
                    ...
                    <h1><span style="color: #132b4e;">Consumer Needs Policy and Procedure</span></h1>
                    <h1><span style="color: #132b4e;">(AP2)</span></h1>
                    <ul></ul>
                    <h2><span style="color: #e6bb73;">Policy Statement</span></h2>
                    <p>The purpose of the Consumer Needs Policy and Procedure is designed to ensure that Lia College works
                    ...
                    <p>This policy applies to Lia College consumers, representatives of consumers, external service
                        providers, Lia College board members, staff and management and medical professionals.</p>
                    <ul></ul>
                    ...
                    <p>All decision-making about our <em>Consumer Needs</em><em> Procedure</em> is carried out in accordance
                        with the principles of our <em>Consumer Needs Policy</em>.</p>
                    <ul></ul>
                    <h3><span style="color: #fcb53b;">Consumer Needs Principles</span></h3>
    ...
    <table class="table table-bordered mb-0" style="min-width: 760px;">
                        <tbody>
                            <tr>
                                <td width="151"><strong>Term</strong></td>
                                <td width="331"><strong>Meaning</strong></td>
                                <td width="160"><strong>Source</strong></td>
                            </tr>
                            <tr>
                                <td width="151">Consumer</td>
                                <td width="331">a)&nbsp;&nbsp;&nbsp; A person to whom an approved provider provides, or
                                    is to provide, care through an aged care service.<p></p>
                                    <p>b)&nbsp;&nbsp;&nbsp; A reference to a consumer in a provision of the Aged Care
                                        Quality Standards set out in Schedule 2 includes a reference to a representative of
                                        the consumer, so far as the provision is capable of applying to a representative of
                                        a consumer.</p>
                                </td>
                                <td width="160">Quality of Care Principles 2014</td>
                            </tr>
                            <tr>
                                <td width="151">Representative</td>
                                <td width="331">a)&nbsp;&nbsp;&nbsp; A person nominated by the consumer as a person to be
                                    told about matters affecting the consumer; or<p></p>
                                    <p>b)&nbsp;&nbsp;&nbsp; A person:</p>
                                    <p>i.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; who nominates themselves as a person to
                                        be told about matters affecting a consumer; and</p>
                                    <p>ii.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; who the relevant organisation is
                                        satisfied has a connection with the consumer and is concerned for the safety, health
                                        and well being of the consumer.</p>
                                </td>
                                <td width="160">Quality of Care Principles 2014</td>
                            </tr>
                            <tr>
                                <td width="151">Person Centred Approach</td>
                                <td width="331">a)&nbsp;&nbsp;&nbsp; Supports the person, at the ‘centre of the service’,
                                    to be involved in making decisions about their life.<p></p>
                                    <p>b)&nbsp;&nbsp;&nbsp; Takes into account each person’s life experience, age, gender,
                                        culture, heritage, language, beliefs and identity.</p>
                                    <p>c)&nbsp;&nbsp;&nbsp;&nbsp; Requires flexible services and support to suit the
                                        person’s wishes and priorities.</p>
                                </td>
                                <td width="160">NSW Department of Health</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <p>Lia College requires that induction and ongoing training of all staff include the Consumer Needs
    ...
    <table class="table table-bordered mb-0" style="min-width: 760px;">
                        <tbody>
                            <tr>
                                <td width="151"><strong>Policy Created/ Reviewed</strong></td>
                                <td width="331"><strong>Modifications</strong></td>
                                <td width="160"><strong>Next Review Date</strong></td>
                            </tr>
                            <tr>
                                <td width="151">Implemented September 2022</td>
                                <td width="331"></td>
                                <td width="160">February 2023</td>
                            </tr>
                            <tr>
                                <td width="151">
                                    <ul></ul>
                    ...
                    <ul></ul>
                    <h2><span style="color: #e6bb73;">Consumer Needs Procedure</span></h2>
                    <p>Medical or Nurse Practitioners, Home Support Assessors (from the My Aged Care Regional Assessment
