...
@section('content')
    ...
    <table class="table table-bordered mb-0" style="min-width: 760px;">
                        <tbody>
                            ...
                            <tr>
                                <td width="179">Consumer</td>
                                <td width="302">
                                    <ul>
                                        <li>A person to whom an approved provider provides, or is to provide, care through
                                            an aged care service.</li>
                                        <li>A reference to a consumer in a provision of the Aged Care Quality Standards set
                                            out in Schedule 2 includes a reference to a representative of the consumer, so
                                            far as the provision is capable of applying to a representative of a consumer.
                                        </li>
                                    </ul>
                                </td>
                            ...
                            <tr>
                                <td width="179">Person Centred Approach</td>
                                <td width="302">
                                    <ul>
                                        <li>Supports the person, at the ‘centre of the service’, to be involved in making
                                            decisions about their life.</li>
                                        <li>Takes into account each person’s life experience, age, gender, culture,
                                            heritage, language, beliefs and identity.</li>
                                        <li>Requires flexible services and support to suit the person’s wishes and
                                            priorities.</li>
                                    </ul>
                                </td>
                            ...
                            <tr>
                                <td width="179">Choice</td>
                                <td width="302">A person’s right to make informed choices, to understand their options,
                                    and to be as independent as they want.</td>
                                <td width="160">Aged Care Quality Standards – Standard 1, Consumer dignity and choice
                                </td>
                            </tr>
                            <tr>
                                <td width="179">Dignity of Risk</td>
                                <td width="302">Dignity of risk is about the right of consumers to make their own
                                    decisions about their care and services, as well as their right to take risks, with
                                    support of the organisation.</td>
                                <td width="160">Aged Care Quality and Safety Commission</td>
                            </tr>
                        </tbody>
                    </table>
                    </div>
    ...
    <table class="table table-bordered mb-0" style="min-width: 760px;">
                        <tbody>
                            ...
                            <tr>
                                <td width="179">Implemented March 2022</td>
                                <td width="302"></td>
