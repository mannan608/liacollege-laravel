        ...
        <div class="private-page py-5">
            ...
            <div class="">
                <div class="et_pb_module et_pb_post_content et_pb_post_content_0_tb_body">
                    ...
                    <ul></ul>
                    <h3><span style="color: #fcb53b;">Protect</span></h3>
                    <p>Protect the rights, choices and dignity of individuals.</p>
                    <ul></ul>
                    <h3><span style="color: #fcb53b;">Welcome</span></h3>
                    <p>Be warm and gracious, inclusive and empathetic.</p>
                    <ul></ul>
                    <h3><span style="color: #fcb53b;">Compassion</span></h3>
                    <p>Respond to needs, provide comfort and implement the highest standard of personal and clinical care.
                    </p>
                    <ul></ul>
                    <h3><span style="color: #fcb53b;">Hope</span></h3>
                    <p>Enhance independence, promote joy and provide help to ensure a rich and fulfilled life.</p>
                    <ul></ul>
                    <h3><span style="color: #fcb53b;">Connect</span></h3>
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-bordered mb-0" style="min-width: 760px;">
                            <tbody>
                                ...
                                <tr>
                                    <td width="179">Face-to-face</td>
                                    <td width="302">These are customers that physically walk into the store.</td>
                                    <td width="160">Oxford Dictionary</td>
                                </tr>
                                <tr>
                                    <td width="179">Diverse Customers</td>
                    ...
                    <ul>
                        ...
                        <li>In a friendly, professional manner, always let patients, residents, carers and family know you
                            are there to help. If you are busy with another person, advise that you will assist them shortly
                            or ask another staff member to assist them.</li>
                        <li>You should use a combination of open, closed, and reflective questioning techniques to find out
                            exactly what each individual needs.</li>
                        <li>Your farewell statement should be warm, friendly, and genuine.</li>
                        <li>Be always polite and friendly.</li>
                    </ul>
                    <ul></ul>
                    <h3><span style="color: #fcb53b;">Telephone Etiquette</span></h3>
                    <p>Patients, residents, carers and family on the telephone are just as important as those whom we
                    ...
                    <p>If you cannot assist the caller, direct the call to the appropriate person. Ensure the caller knows
                        that you are transferring their call and give them the name of the person you are transferring them
                        to.</p>
                    <ul>
                        <li>If you need to place a call on hold, please ask permission from the caller to do this.</li>
                        <li>If the person they require is not on-site at the time, a message slip must be filled out and
                            personally given to the staff member when they return to the facility.</li>
                        <li>End the conversation in a courteous and professional way by thanking the caller.</li>
                        <li>Any voicemails should be dealt with within 24 hours during normal business hours.</li>
                    </ul>
                    <ul></ul>
                    ...
                    <ul>
                        <li>avoid using jargon</li>
                        <li>ask the other person if they understand what you are saying</li>
                        <li>speak clearly</li>
                        <li>listen carefully to what is said</li>
                        <li>use gestures, drawings, demonstrations, and signs to aid understanding.</li>
                    </ul>
                    <ul></ul>
                    ...
                    <ul>
                        <li>The personal information of all stakeholders will be kept securely and will only be accessed by
                            authorised staff.</li>
                        <li>To ensure this information is kept secure, it is essential for all staff to access computerised
                            records with their unique staff identification number. Do not give this number to anyone else.
                        </li>
                    ...
                    <ul></ul>
                    <h3><span style="color: #fcb53b;">Team Communication</span></h3>
                    <ul>
                        <li>Employees are expected to communicate with all stakeholders in a respectful and professional
                            manner.</li>
                        <li>Employees will not engage with patients, residents, carers or a patient’s family on social
                            media, using personal or company profiles.</li>
                    </ul>
