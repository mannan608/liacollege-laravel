...
@section('content')
        ...
        <div class="private-page py-5">
            ...
            <div class="">
                <div class="et_pb_module et_pb_post_content et_pb_post_content_0_tb_body">
                    ...
                    <p>Establishing a continuous improvement policy is our organisation’s effort to improve its entire
                        operation, from products to services to its staff and management. By aiming for a high level of
                    ...
                    <ul>
                        <li>A continuous improvement strategy is not a program with a start and end date. It is an ongoing
                            process that is continued throughout the life of the business.</li>
                        <li>Both achievements and failures within the business must be seen as an opportunity for change and
    ...
    <table class="table table-bordered mb-0" style="min-width: 760px;">
                        <tbody>
                            ...
                            <tr>
                                <td width="160">Continuous Improvement</td>
                                <td width="321">The process of making regular small changes and improvements to the
                                    products, services, etc. of a company rather than a few big changes.</td>
                                <td width="160">Cambridge Dictionary</td>
                            </tr>
                            <tr>
                                <td width="160">Stakeholder</td>
                                <td width="321">A person such as an employee, customer or citizen who is involved with an
                                    organisation, society, etc. and therefore has responsibilities towards it and an
                                    interest in its success.</td>
                                <td width="160">Cambridge Dictionary</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <ul>
                        ...
                        <li>Grievances and Complaints Policy and Procedure</li>
    ...
    <table class="table table-bordered mb-0" style="min-width: 760px;">
                    ...
                    <ul>
                        <li>Remind staff regularly about continuous improvement expectations, as well as the whole team’s
                            responsibilities in identifying and helping facilitate any need for change.</li>
                        <li>Maintain a register for staff to complete when noting any continuous improvement suggestions.
                        </li>
                        <li>They will thoroughly investigate, consider and act on any information gathered and presented
                            both formally and informally.</li>
                        <li>Design and implement a procedure for customer/stakeholder feedback as a mechanism to identify
                            continuous improvement requirements.</li>
                        <li>Maintain records of identified risk assessments to facilitate continuous improvement.</li>
                        <li>Define and incorporate a continuous improvement cycle into its daily operations to demonstrate
                            how the process of continuous improvement is ongoing and not static.</li>
                    </ul>
                    <ul></ul>
                    ...
                    <ul>
                        ...
                        <li>Benchmark operational processes and regularly measure performance.</li>
                        <li>Ensure communication with peers and management remains open and valued culture.</li>
                        <li>Focus on effective time management.</li>
                    ...
                    <ul>
                        <li>Plan – Identify and clearly define the problem, set realistic and achievable goals.</li>
                        <li>Do – Gain support from relevant stakeholders for desired solution. Implement proposed solution.
                        </li>
                        <li>Check – Gather feedback and satisfaction on performance/outcome of implemented solution.</li>
                    </ul>
                    <p>If positive, go to Act. If unsatisfactory, revisit Plan.</p>
                    <ul>
                        <li>Act – Determine any training and system change requirements. Implement ongoing monitoring and
                            review and any continuous improvement requirements.</li>
                    </ul>
