            ...
            <div class="p-6 bg-gradient-to-br from-brand-500 via-brand-600 to-brand-500 text-white relative overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <div class="mt-5">
                        ...
                        <p class="text-xs text-brand-100 mt-2">{{ $completedCount }} of {{ $totalLessons }} lessons
                            completed</p>
                    </div>
                </div>
            </div>
    ...
    <main id="learning-portal-main" class="flex-1 overflow-y-auto bg-slate-50/50">
        ...
        <div class="max-w-5xl mx-auto px-6 lg:px-10 py-8 space-y-6">
            ...
            <div id="lesson-complete-container"
                class="hidden opacity-0 translate-y-3
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const completionElement =
            lessonContent.querySelector('[data-completion-type]');
        ...
        */
        ...
        if (completionType === 'video') {
            ...
            const video =
                completionElement.querySelector('[data-lesson-video]');
