        ...
        <div class="max-w-7xl mx-auto px-6 py-8">
            ...
            <div class="flex flex-col gap-6 mb-10">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="{{ route('student.tasks.index', $course) }}"
                        class="inline-flex items-center gap-2.5 px-4 py-2.5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl hover:border-gray-300 dark:hover:border-gray-700 transition-all text-sm font-medium text-gray-700 dark:text-gray-200">
            ...
            <div
                ...
                <div
                    ...
                    <h4 class="font-medium text-base md:text-lg text-gray-900 dark:text-white">Learning Material</h4>
                </div>
                <div class="p-6">
                            ...
                            <a href="{{ route('student.learning-document.view', $document) }}" target="_blank"
                                ...
                                <div class="flex-1 min-w-0">
                                    <p
                                        ...
                                        {{ $document->name }}</p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">File Size ·
                                        {{ number_format($document->size / 1024, 2) }} KB</p>
                                </div>
