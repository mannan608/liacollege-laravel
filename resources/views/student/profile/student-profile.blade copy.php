            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" value="Ms"
                            class="w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-50 focus:outline-none focus:ring-1 focus:ring-slate-500 focus:border-transparent">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">First name</label>
                        <input type="text" value="Sudikshya"
                            class="w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-50 focus:outline-none focus:ring-1 focus:ring-slate-500 focus:border-transparent">
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" value="05/11/1997"
                            class="w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-50 focus:outline-none focus:ring-1 focus:ring-slate-500 focus:border-transparent">
                    </div>
                    <div>
                ...
                <div class="mb-4">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">City of birth<br><span
                            class="text-xs font-normal text-gray-500">(exactly as per your USI identification
                            records)</span></label>
                    <input type="text" value="Kathmandu"
                        class="w-full md:w-1/2 border border-gray-300 rounded-md px-3 py-2 bg-gray-50 focus:outline-none focus:ring-1 focus:ring-slate-500 focus:border-transparent">
                </div>

                <div class="mb-4">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Unique Student identifier (USI) - required
                    ...
                    <input type="text" value="H7JMEDZXUP"
                        class="w-full md:w-1/2 border border-gray-300 rounded-md px-3 py-2 bg-gray-50 focus:outline-none focus:ring-1 focus:ring-slate-500 focus:border-transparent uppercase tracking-widest font-mono">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <select
                            class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-slate-500 focus:border-transparent bg-white">
                            <option value="not-aboriginal" selected>I am NOT of Aboriginal or Torres Strait Island origin
                            </option>
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">If you have any learning disability which
                    ...
                    <textarea rows="3"
                        class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-slate-500 focus:border-transparent resize-y bg-white"></textarea>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="email" value="placement@liacollege.edu.au"
                            class="w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-50 focus:outline-none focus:ring-1 focus:ring-slate-500 focus:border-transparent">
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <input type="tel" value="0405106199"
                                class="w-1/2 border border-gray-300 rounded-md px-3 py-2 bg-gray-50 focus:outline-none focus:ring-1 focus:ring-slate-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 mb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" value="4"
                            class="w-full md:w-1/2 border border-gray-300 rounded-md px-3 py-2 bg-gray-50 focus:outline-none focus:ring-1 focus:ring-slate-500">
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" value="Bousloff Street"
                                class="w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-50 focus:outline-none focus:ring-1 focus:ring-slate-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" value="WHITLAM"
                                class="w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-50 focus:outline-none focus:ring-1 focus:ring-slate-500">
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-gray-600 mb-1">State</label>
                            <input type="text" value="Australian Capital Territory"
                                class="w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-50 focus:outline-none focus:ring-1 focus:ring-slate-500">
                        </div>
                    </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
                    ...
                    <div class="mb-4">
                        <label class="block text-xs font-semibold text-gray-600 mb-1">Post office box details (e.g. PO Box
                            123)</label>
                        <input type="text"
