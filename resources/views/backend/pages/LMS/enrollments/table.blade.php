        ...
        'cancelled' => 'Cancel',
                        ...
                        <td class="px-4 py-3 text-right">
                            <div class="inline-flex items-center gap-1">
                                @can('student.view')
                                    <a href="{{ role_route('role.student.show', ['student' => $student]) }}"
                                ...
                                @can('student.edit')
                                    <a href="{{ role_route('role.student.edit', ['student' => $student]) }}"
                                ...
                                @can('student.delete')
                                    <form method="POST"
                                        action="{{ role_route('role.student.destroy', ['student' => $student]) }}"
                                        class="inline"
