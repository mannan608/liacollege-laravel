...
<div class="max-w-7xl mx-auto">
     ...
     @if (session('success'))
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div>
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Quiz Management</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400">Manage quiz nad questions.
                </p>
            </div>
   ...
   @include('backend.pages.quiz.quizzes.table', ['items' => $quizzes])
</div>
@endsection
