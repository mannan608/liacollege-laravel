...
@php
$oldIncludes = old('includes', $course->includes->toArray());
...
@section('content')
    <form x-data="courseForm()" action="{{ role_route('role.courses.update', ['course' => $course->id]) }}" method="POST"
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <div class="p-5 space-y-5">
                        ...
                        <div class="grid grid-cols-1 gap-5">
                            {{-- Name --}}
                            <x-form.input-text name="name" label="Course Name" value="{{ old('name', $course->name) }}"
                            ...
                            {{-- Cricos --}}
                            <x-form.input-text name="cricos" label="Cricos No" value="{{ old('cricos', $course->cricos) }}"
                                placeholder="Enter Cricos No..." />
                        </div>

                        <x-form.file-uploader name="thumbnail" label="Thumbnail" accept="image/*" :existing="$course->thumbnail ? asset($course->thumbnail) : null" />
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <div class="p-5 space-y-5">
                        <x-form.select-input name="course_category_id" label="Category" value="{{ old('course_category_id', $course->course_category_id) }}" :options="$categories" />
                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <x-form.input-text name="duration" label="Duration" value="{{ old('duration', $course->duration) }}"
                            placeholder="3 Hours" />
