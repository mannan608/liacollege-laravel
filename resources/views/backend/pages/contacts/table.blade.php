...
<div x-data="{
    ...
    <form x-ref="deleteForm" :action="rowToDelete ? (contactBaseUrl + '/' + rowToDelete.id) : '#'" method="POST"
        class="hidden">
        @csrf
        @method('DELETE')
    </form>
    ...
    <div x-show="showDeleteModal" x-cloak class="fixed inset-0 z-99999">
        ...
        <div class="absolute inset-0 flex items-center justify-center p-4">
            <div
                ...
                <div class="p-5">
                    <div class="text-base font-semibold text-gray-800 dark:text-white/90">Delete contact?</div>
            ...
            <table class="w-full text-left border-collapse">
                <thead class="bg-gray-50 dark:bg-white/2 border-b border-gray-100 dark:border-white/5">
                    <tr>
                        ...
                        <th class="px-5 py-4 text-xs font-medium text-gray-500 uppercase tracking-wider">Type</th>
