    ...
    <div class="grid gap-6 p-6 md:grid-cols-2">
        <div class="group">
            ...
            <div class="relative">
                ...
                <div
                    class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3 opacity-0 peer-valid:opacity-100">
        ...
        <div class="group">
            <label for="password"
                ...
                @else
                    <span
                        class="ml-1 rounded-full bg-amber-100 px-2 py-0.5 text-xs font-medium text-amber-700 dark:bg-amber-900/30 dark:text-amber-400">Optional</span>
                @endif
            </label>
            <div class="relative">
                <input id="password" name="password" type="password" @if (!$user) required @endif
        ...
        <div class="group">
            ...
            <input id="password_confirmation" name="password_confirmation" type="password"
                @if (!$user) required @endif placeholder="Re-enter password"
                class="block w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 transition-colors focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-600 dark:bg-gray-900 dark:text-white dark:placeholder-gray-500 dark:focus:border-brand-500">
        </div>
